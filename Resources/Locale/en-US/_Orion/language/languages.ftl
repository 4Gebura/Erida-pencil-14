...
language-Codespeak-name = Syndicate Codespeak
language-Codespeak-description =
    Military codes used by Syndicate.
language-CorporateCodespeak-name = Corporate Codespeak
language-CorporateCodespeak-description = Corporate dialects, presented in the form of a codes, used by NanoTrasen.
