...
uplink-inteq-radio-implanter-desc = Импланитрует радио ШтеуЙ, позволяя скрыто общаться без гарнитуры.
...
uplink-inteq-plasma-scythe-desc = Гораздо более дорогая альтернатива плазменной косе: с большим шансом отражения, большим углом атаки, более высоким уроном по конструкциям и большей скоростью замаха. Требует сварочное топливо для работы
