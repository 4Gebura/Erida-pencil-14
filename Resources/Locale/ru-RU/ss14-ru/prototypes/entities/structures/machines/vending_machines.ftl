...
ent-VendingMachineSustenance = тюремный торгомат
    .desc = Торговый автомат, который реализует продукты питания, как того требует раздел 47-C Соглашения об этическом обращении с заключёнными Пакта.
...
ent-VendingMachineSyndieDrobe = СиндиШкаф
    .desc = Шкаф-машина, закодированная Синдикатом, содержит элитную экипировку.
