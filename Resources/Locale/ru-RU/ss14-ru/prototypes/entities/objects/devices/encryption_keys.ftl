...
ent-EncryptionKeyBinarySyndicate = ключ двоичного перевода
    .desc = Ключ шифрования InteQ, используемый для преобразования двоичного кода, используемого синтетиками.
...
ent-EncryptionKeyLaw = ключ шифрования юридического отдела.
    .desc = Ключ шифрования, используемый юридическим отделом.
