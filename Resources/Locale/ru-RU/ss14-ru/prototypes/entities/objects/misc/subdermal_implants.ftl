...
ent-RadioImplant = имплант "радио"
    .desc = Этот имплант даёт доступ к радиочастоте InteQ без гарнитуры.
ent-UplinkImplant = имплант "аплинк"
    .desc = Этот имплант позволяет пользователю получить доступ к скрытому аплинку InteQ по желанию.
...
ent-FakeMindShieldImplant = имплант "фальшивый Щит разума"
    .desc = Этот имплант позволяет имплантеру генерировать фальшивый сигнал, по которому охранные визоры Пакта идентифицируют людей, имплантированных Щитом разума.
ent-MindShieldImplant = имплант "Щит разума"
    .desc = Этот имплант обеспечит лояльность Пакту и предотвратит использование устройств контроля разума.
